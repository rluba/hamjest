...
var matchers = {
	...
	promiseAllOf: require('./matchers/PromiseAllOf').promiseAllOf,
	willHaveProperties: require('./matchers/willHaveProperties'),
	willHaveProperty: require('./matchers/willHaveProperties').willHaveProperty
};
