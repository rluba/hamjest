...
function IsObjectWithProperties(properties, deep = false) {
	const propertyMatchers = _.mapValues(properties, value => {
		if (deep && value && !isMatcher(value) && (value.constructor === Object || Object.getPrototypeOf(value) === null)) {
			return new IsObjectWithProperties(value);
		}
