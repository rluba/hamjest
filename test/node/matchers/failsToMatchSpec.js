...
describe('failsToMatch(value)', function () {
	...
	], _.spread(function (actualMatcher, value, expectedDescription, matchResult) {
		it('should only match if the actual matcher fails to match the given value and the mismatch description is as expected: ' + [__.describe(actualMatcher), value, __.describe(expectedDescription), matchResult].join(' / '), function () {
